-- cc4030fdc3914b439be66b817f4c2a57 https://api-2445581299940.staging.apicast.io:443 http://104.197.206.174:80 2555417727534 104.197.206.174 --
-- -*- mode: lua; -*-
-- Generated on: 2015-11-12 05:53:32 +0000 --
-- Version:
...
service_2555417727534 = {
  error_auth_failed = 'Authentication failed',
  error_auth_missing = 'Authentication parameters missing123',
  ...
  secret_token = 'Shared_secret_sent_from_proxy_to_API_backend_c6bda93a7267c8e0'
}
...
matched_rules2 = ""
  ...
  function extract_usage_2555417727534(request)
...
function get_debug_value()
  ...
  if h["X-3scale-debug"] == 'cc4030fdc3914b439be66b817f4c2a57' then
    return true
  else
    return false
  end
...
local auth_strat = ""
local service = {}
if ngx.var.service_id == '2555417727534' then
  local parameters = get_auth_params("not_headers", string.split(ngx.var.request, " ")[1] )
  service = service_2555417727534 --
  ngx.var.secret_token = service.secret_token
  ngx.var.access_token = parameters.access_token
  params.access_token = parameters.access_token
  get_credentials_access_token(params , service_2555417727534)
  ngx.var.cached_key = "2555417727534" .. ":" .. params.access_token
  auth_strat = "oauth"
  ngx.var.service_id = "2555417727534"
  ngx.var.proxy_pass = "http://backend_104.197.206.174"
  ngx.var.usage = extract_usage_2555417727534(ngx.var.request)
end
