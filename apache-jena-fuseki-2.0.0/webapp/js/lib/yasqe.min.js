!function (e) {
    if ("object" == typeof exports && "undefined" != typeof module)module.exports = e(); else if ("function" == typeof define && define.amd)define([], e); else {
        var i;
        "undefined" != typeof window ? i = window : "undefined" != typeof global ? i = global : "undefined" != typeof self && (i = self), i.YASQE = e()
    }
}(function () {
    var e;
    return function i(e, r, n) {
        function o(s, a) {
            if (!r[s]) {
                if (!e[s]) {
                ...
                var E = r[s] = {exports: {}};
                e[s][0].call(E.exports, function (i) {
                    var r = e[s][1][i];
                    return o(r ? r : i)
                }, E, E.exports, i, e, r, n)
            }
        ...
        for (var t = "function" == typeof require && require, s = 0; s < n.length; s++)o(n[s]);
        return o
    }({
        1: [function (e, i) {
            i.exports = e("./main.js")
        }, {"./main.js": 29}], 2: [function (e) {
            "use strict";
            var i = function () {
                try {
                    return e("jquery")
            ...
            i.deparam = function (e, r) {
                var n = {}, o = {"true": !0, "false": !1, "null": null};
                i.each(e.replace(/\+/g, " ").split("&"), function (e, t) {
                    var s, a = t.split("="), p = decodeURIComponent(a[0]), l = n, E = 0, u = p.split("]["), c = u.length - 1;
                    if (/\[/.test(u[0]) && /\]$/.test(u[c])) {
                        u[c] = u[c].replace(/\]$/, "");
                    ...
                    if (2 === a.length) {
                        ...
                        r && (s = s && !isNaN(s) ? +s : "undefined" === s ? void 0 : void 0 !== o[s] ? o[s] : s);
                        if (c)for (; c >= E; E++) {
                            p = "" === u[E] ? l.length : u[E];
                            l = l[p] = c > E ? l[p] || (u[E + 1] && isNaN(u[E + 1]) ? {} : []) : s
                        } else i.isArray(n[p]) ? n[p].push(s) : n[p] = void 0 !== n[p] ? [n[p], s] : s
                    } else p && (n[p] = r ? void 0 : "")
                });
                return n
            }
        }, {jquery: void 0}], 3: [function (e, i) {
            i.exports = {
                table: {
                    "*[&&,valueLogical]": {
                    ...
                    "*datasetClause": {FROM: ["datasetClause", "*datasetClause"], WHERE: [], "{": []},
                    ...
                    "?SILENT_2": {SILENT: ["SILENT"], GRAPH: [], DEFAULT: [], NAMED: [], ALL: []},
                    "?SILENT_3": {SILENT: ["SILENT"], GRAPH: []},
                    "?SILENT_4": {SILENT: ["SILENT"], DEFAULT: [], GRAPH: [], IRI_REF: [], PNAME_LN: [], PNAME_NS: []},
                    "?WHERE": {WHERE: ["WHERE"], "{": []},
                    ...
                    "?[.,?triplesTemplate]": {".": ["[.,?triplesTemplate]"], "}": [], GRAPH: []},
                    ...
                    "?orderClause": {ORDER: ["orderClause"], VALUES: [], LIMIT: [], OFFSET: [], $: [], "}": []},
                    "?pathMod": {
                        "*": ["pathMod"],
                        "?": ["pathMod"],
                        "+": ["pathMod"],
                    ...
                    "[^^,iriRef]": {"^^": ["^^", "iriRef"]},
                    "[constructTemplate,*datasetClause,whereClause,solutionModifier]": {"{": ["constructTemplate", "*datasetClause", "whereClause", "solutionModifier"]},
                    "[deleteClause,?insertClause]": {DELETE: ["deleteClause", "?insertClause"]},
                    "[graphPatternNotTriples,?.,?triplesBlock]": {
                        "{": ["graphPatternNotTriples", "?.", "?triplesBlock"],
                    ...
                    "[integer,or([[,,or([},[integer,}]])],}])]": {INTEGER: ["integer", "or([[,,or([},[integer,}]])],}])"]},
                    ...
                    "[quadsNotTriples,?.,?triplesTemplate]": {GRAPH: ["quadsNotTriples", "?.", "?triplesTemplate"]},
                    "[update1,?[;,update]]": {
                        INSERT: ["update1", "?[;,update]"],
                        DELETE: ["update1", "?[;,update]"],
                        LOAD: ["update1", "?[;,update]"],
                    ...
                    "[|,pathSequence]": {"|": ["|", "pathSequence"]},
                    "[||,conditionalAndExpression]": {"||": ["||", "conditionalAndExpression"]},
                    add: {ADD: ["ADD", "?SILENT_4", "graphOrDefault", "TO", "graphOrDefault"]},
                    additiveExpression: {
                    ...
                    allowBnodes: {"}": []},
                    allowVars: {"}": []},
                    argList: {NIL: ["NIL"], "(": ["(", "?DISTINCT", "expression", "*[,,expression]", ")"]},
                    ...
                    constructQuery: {CONSTRUCT: ["CONSTRUCT", "or([[constructTemplate,*datasetClause,whereClause,solutionModifier],[*datasetClause,WHERE,{,?triplesTemplate,},solutionModifier]])"]},
                    ...
                    copy: {COPY: ["COPY", "?SILENT_4", "graphOrDefault", "TO", "graphOrDefault"]},
                    ...
                    datasetClause: {FROM: ["FROM", "or([defaultGraphClause,namedGraphClause])"]},
                    defaultGraphClause: {
                    ...
                    describeDatasetClause: {FROM: ["FROM", "or([defaultGraphClause,namedGraphClause])"]},
                    describeQuery: {DESCRIBE: ["DESCRIBE", "or([+varOrIRIref,*])", "*describeDatasetClause", "?whereClause", "solutionModifier"]},
                    disallowBnodes: {
                        "}": [],
                        GRAPH: [],
                        VAR1: [],
                    ...
                    expressionList: {NIL: ["NIL"], "(": ["(", "expression", "*[,,expression]", ")"]},
                    ...
                    graphRefAll: {GRAPH: ["graphRef"], DEFAULT: ["DEFAULT"], NAMED: ["NAMED"], ALL: ["ALL"]},
                    graphTerm: {
                        IRI_REF: ["iriRef"],
                        PNAME_LN: ["iriRef"],
                        PNAME_NS: ["iriRef"],
                    ...
                    groupGraphPattern: {"{": ["{", "or([subSelect,groupGraphPatternSub])", "}"]},
                    ...
                    integer: {INTEGER: ["INTEGER"]},
                    iriRef: {IRI_REF: ["IRI_REF"], PNAME_LN: ["prefixedName"], PNAME_NS: ["prefixedName"]},
                    iriRefOrFunction: {
                        IRI_REF: ["iriRef", "?argList"],
                        PNAME_LN: ["iriRef", "?argList"],
                        PNAME_NS: ["iriRef", "?argList"]
                    ...
                    modify: {WITH: ["WITH", "iriRef", "or([[deleteClause,?insertClause],insertClause])", "*usingClause", "WHERE", "groupGraphPattern"]},
                    move: {MOVE: ["MOVE", "?SILENT_4", "graphOrDefault", "TO", "graphOrDefault"]},
                    ...
                    numericLiteralUnsigned: {INTEGER: ["INTEGER"], DECIMAL: ["DECIMAL"], DOUBLE: ["DOUBLE"]},
                    object: {
                        "(": ["graphNode"],
                        "[": ["graphNode"],
                        VAR1: ["graphNode"],
                    ...
                    "or([LANGTAG,[^^,iriRef]])": {LANGTAG: ["LANGTAG"], "^^": ["[^^,iriRef]"]},
                    "or([NIL,[ (,*var,)]])": {NIL: ["NIL"], "(": ["[ (,*var,)]"]},
                    "or([[ (,*dataBlockValue,)],NIL])": {"(": ["[ (,*dataBlockValue,)]"], NIL: ["NIL"]},
                    ...
                    "or([iriRef,a])": {IRI_REF: ["iriRef"], PNAME_LN: ["iriRef"], PNAME_NS: ["iriRef"], a: ["a"]},
                    ...
                    quadsNotTriples: {GRAPH: ["GRAPH", "varOrIRIref", "{", "?triplesTemplate", "}"]},
                    queryAll: {
                    ...
                    selectClause: {SELECT: ["SELECT", "?or([DISTINCT,REDUCED])", "or([+or([var,[ (,expression,AS,var,)]]),*])"]},
                    selectQuery: {SELECT: ["selectClause", "*datasetClause", "whereClause", "solutionModifier"]},
                    serviceGraphPattern: {SERVICE: ["SERVICE", "?SILENT", "varOrIRIref", "groupGraphPattern"]},
                    solutionModifier: {
                    ...
                    sourceSelector: {IRI_REF: ["iriRef"], PNAME_LN: ["iriRef"], PNAME_NS: ["iriRef"]},
                    sparql11: {
                    ...
                    storeProperty: {VAR1: [], VAR2: [], IRI_REF: [], PNAME_LN: [], PNAME_NS: [], a: []},
                    ...
                    subSelect: {SELECT: ["selectClause", "whereClause", "solutionModifier", "valuesClause"]},
                    ...
                    whereClause: {"{": ["?WHERE", "groupGraphPattern"], WHERE: ["?WHERE", "groupGraphPattern"]}
                },
            ...
            i.defineMode("sparql11", function (i) {
                function r() {
                    var e = "<[^<>\"'|{}^\\\x00- ]*>", i = "[A-Za-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD]", r = i + "|_", n = "(" + r + "|-|[0-9\\u00B7\\u0300-\\u036F\\u203F-\\u2040])", o = "(" + r + "|[0-9])(" + r + "|[0-9\\u00B7\\u0300-\\u036F\\u203F-\\u2040])*", t = "\\?" + o, s = "\\$" + o, a = "(" + i + ")(((" + n + ")|\\.)*(" + n + "))?", p = "[0-9A-Fa-f]", l = "(%" + p + p + ")", E = "(\\\\[_~\\.\\-!\\$&'\\(\\)\\*\\+,;=/\\?#@%])", u = "(" + l + "|" + E + ")", c = "(" + r + "|:|[0-9]|" + u + ")((" + n + "|\\.|:|" + u + ")*(" + n + "|:|" + u + "))?", d = "_:(" + r + "|[0-9])((" + n + "|\\.)*" + n + ")?", N = "(" + a + ")?:", I = N + c, x = "@[a-zA-Z]+(-[a-zA-Z0-9]+)*", m = "[eE][\\+-]?[0-9]+", L = "[0-9]+", T = "(([0-9]+\\.[0-9]*)|(\\.[0-9]+))", A = "(([0-9]+\\.[0-9]*" + m + ")|(\\.[0-9]+" + m + ")|([0-9]+" + m + "))", g = "\\+" + L, S = "\\+" + T, R = "\\+" + A, v = "-" + L, h = "-" + T, C = "-" + A, f = "\\\\[tbnrf\\\\\"']", O = p + "{4}", y = "(\\\\u" + O + "|\\\\U00(10|0" + p + ")" + O + ")", P = "'(([^\\x27\\x5C\\x0A\\x0D])|" + f + "|" + y + ")*'", _ = '"(([^\\x22\\x5C\\x0A\\x0D])|' + f + "|" + y + ')*"', D = "'''(('|'')?([^'\\\\]|" + f + "|" + y + "))*'''", b = '"""(("|"")?([^"\\\\]|' + f + "|" + y + '))*"""', G = "[\\x20\\x09\\x0D\\x0A]", M = "#([^\\n\\r]*[\\n\\r]|[^\\n\\r]*$)", U = "(" + G + "|(" + M + "))*", B = "\\(" + U + "\\)", V = "\\[" + U + "\\]", k = {
                        terminal: [{
                            name: "WS",
                            regex: new RegExp("^" + G + "+"),
                            style: "ws"
                        }, {name: "COMMENT", regex: new RegExp("^" + M), style: "comment"}, {
                            name: "IRI_REF",
                            regex: new RegExp("^" + e),
                            style: "variable-3"
                        }, {name: "VAR1", regex: new RegExp("^" + t), style: "atom"}, {
                            name: "VAR2",
                            regex: new RegExp("^" + s),
                            style: "atom"
                        }, {name: "LANGTAG", regex: new RegExp("^" + x), style: "meta"}, {
                            name: "DOUBLE",
                            regex: new RegExp("^" + A),
                            style: "number"
                        }, {name: "DECIMAL", regex: new RegExp("^" + T), style: "number"}, {
                            name: "INTEGER",
                            regex: new RegExp("^" + L),
                            style: "number"
                        }, {
                            ...
                            regex: new RegExp("^" + b),
                            style: "string"
                        }, {name: "STRING_LITERAL1", regex: new RegExp("^" + P), style: "string"}, {
                            name: "STRING_LITERAL2",
                            regex: new RegExp("^" + _),
                            style: "string"
                        }, {name: "NIL", regex: new RegExp("^" + B), style: "punc"}, {
                            name: "ANON",
                            regex: new RegExp("^" + V),
                            style: "punc"
                        }, {name: "PNAME_LN", regex: new RegExp("^" + I), style: "string-2"}, {
                            name: "PNAME_NS",
                            regex: new RegExp("^" + N),
                            style: "string-2"
                        }, {name: "BLANK_NODE_LABEL", regex: new RegExp("^" + d), style: "string-2"}]
                    };
                    return k
                }
                ...
                function n(e) {
                    var i = [], r = a[e];
                    if (void 0 != r)for (var n in r)i.push(n.toString()); else i.push(e);
                    return i
                }

                function o(e, i) {
                    function r() {
                        for (var i = null, r = 0; r < l.length; ++r) {
                            i = e.match(l[r].regex, !0, !1);
                            if (i)return {cat: l[r].name, style: l[r].style, text: i[0]}
                        }
                        i = e.match(s.keywords, !0, !1);
                        if (i)return {cat: e.current().toUpperCase(), style: "keyword", text: i[0]};
                        i = e.match(s.punct, !0, !1);
                        if (i)return {cat: e.current(), style: "punc", text: i[0]};
                        i = e.match(/^.[A-Za-z0-9]*/, !0, !1);
                        return {cat: "<invalid_token>", style: "error", text: i[0]}
                    }

                    function o() {
                        var r = e.column();
                        i.errorStartPos = r;
                        i.errorEndPos = r + u.text.length
                    }

                    function t(e) {
                        null == i.queryType && ("SELECT" == e || "CONSTRUCT" == e || "ASK" == e || "DESCRIBE" == e || "INSERT" == e || "DELETE" == e || "LOAD" == e || "CLEAR" == e || "CREATE" == e || "DROP" == e || "COPY" == e || "MOVE" == e || "ADD" == e) && (i.queryType = e)
                    }

                    function p(e) {
                        "disallowVars" == e ? i.allowVars = !1 : "allowVars" == e ? i.allowVars = !0 : "disallowBnodes" == e ? i.allowBnodes = !1 : "allowBnodes" == e ? i.allowBnodes = !0 : "storeProperty" == e && (i.storeProperty = !0)
                    }

                    function E(e) {
                        return (i.allowVars || "var" != e) && (i.allowBnodes || "blankNode" != e && "blankNodePropertyList" != e && "blankNodePropertyListPath" != e)
                    }

                    0 == e.pos && (i.possibleCurrent = i.possibleNext);
                    var u = r();
                    if ("<invalid_token>" == u.cat) {
                        if (1 == i.OK) {
                            i.OK = !1;
                            o()
                        }
                    ...
                    if ("WS" == u.cat || "COMMENT" == u.cat) {
                        i.possibleCurrent = i.possibleNext;
                        return u.style
                    }
                    for (var c, d = !1, N = u.cat; i.stack.length > 0 && N && i.OK && !d;) {
                        c = i.stack.pop();
                        if (a[c]) {
                            var I = a[c][N];
                            if (void 0 != I && E(c)) {
                                for (var x = I.length - 1; x >= 0; --x)i.stack.push(I[x]);
                                p(c)
                            } else {
                                i.OK = !1;
                                i.complete = !1;
                            ...
                            d = !0;
                            t(c);
                            for (var m = !0, L = i.stack.length; L > 0; --L) {
                                var T = a[i.stack[L - 1]];
                                T && T.$ || (m = !1)
                            }
                            i.complete = m;
                            if (i.storeProperty && "punc" != N.cat) {
                                i.lastProperty = u.text;
                                i.storeProperty = !1
                            }
                        } else {
                            i.OK = !1;
                    ...
                    i.possibleCurrent = i.possibleNext;
                    i.possibleNext = n(i.stack[i.stack.length - 1]);
                    return u.style
                }

                function t(e, r) {
                    var n = 0, o = e.stack.length - 1;
                    if (/^[\}\]\)]/.test(r)) {
                        for (var t = r.substr(0, 1); o >= 0; --o)if (e.stack[o] == t) {
                            --o;
                            break
                        }
                    } else {
                    ...
                    return n * i.indentUnit
                }

                var s = (i.indentUnit, e("./_tokenizer-table.js")), a = s.table, p = r(), l = p.terminal, E = {
                    "*[,, object]": 3,
                    "*[(,),object]": 3,
                    "*[(,),objectPath]": 3,
                    "*[/,pathEltOrInverse]": 2,
                ...
                }, u = {"}": 1, "]": 0, ")": 1, "{": -1, "(": -1, "*[;,?[or([verbPath,verbSimple]),objectList]]": 1};
                return {
                    token: o, startState: function () {
                        return {
                            tokenize: o,
                            OK: !0,
                            complete: s.acceptEmpty,
                            errorStartPos: null,
                            errorEndPos: null,
                            queryType: null,
                            possibleCurrent: n(s.startSymbol),
                            possibleNext: n(s.startSymbol),
                            allowVars: !0,
                            allowBnodes: !0,
                            storeProperty: !1,
                            lastProperty: "",
                    ...
                    }, indent: t, electricChars: "}])"
                }
            });
            i.defineMIME("application/x-sparql-query", "sparql11")
        }, {"./_tokenizer-table.js": 3, codemirror: void 0}], 5: [function (e, i) {
            var r = i.exports = function () {
                this.words = 0;
                this.prefixes = 0;
                this.children = []
            };
            r.prototype = {
                insert: function (e, i) {
                    if (0 != e.length) {
                        ...
                        if (i !== e.length) {
                            t.prefixes++;
                            n = e[i];
                            void 0 === t.children[n] && (t.children[n] = new r);
                            o = t.children[n];
                            o.insert(e, i + 1)
                        } else t.words++
                    }
                ...
                }, countWord: function (e, i) {
                    if (0 == e.length)return 0;
                    var r, n, o = this, t = 0;
                    void 0 === i && (i = 0);
                    if (i === e.length)return o.words;
                    r = e[i];
                    n = o.children[r];
                    void 0 !== n && (t = n.countWord(e, i + 1));
                    return t
                }, countPrefix: function (e, i) {
                    if (0 == e.length)return 0;
                    var r, n, o = this, t = 0;
                    void 0 === i && (i = 0);
                    if (i === e.length)return o.prefixes;
                    var r = e[i];
                    n = o.children[r];
                    void 0 !== n && (t = n.countPrefix(e, i + 1));
                    return t
                }, find: function (e) {
                    return 0 == e.length ? !1 : this.countWord(e) > 0 ? !0 : !1
                }, getAllWords: function (e) {
                    var i, r, n = this, o = [];
                    void 0 === e && (e = "");
                    if (void 0 === n)return [];
                    n.words > 0 && o.push(e);
                    for (i in n.children) {
                        r = n.children[i];
                        o = o.concat(r.getAllWords(e + i))
                    }
                    return o
                }, autoComplete: function (e, i) {
                    var r, n, o = this;
                    if (0 == e.length)return void 0 === i ? o.getAllWords(e) : [];
                    void 0 === i && (i = 0);
                    r = e[i];
                    n = o.children[r];
                    return void 0 === n ? [] : i === e.length - 1 ? n.getAllWords(e) : n.autoComplete(e, i + 1)
                }
            }
        }, {}], 6: [function (i, r, n) {
            (function (o) {
                "object" == typeof n && "object" == typeof r ? o(function () {
                    try {
                        return i("codemirror")
                    } catch (e) {
                        return window.CodeMirror
                    }
                }()) : "function" == typeof e && e.amd ? e(["../../lib/codemirror"], o) : o(CodeMirror)
            })(function (e) {
                "use strict";
                function i(e) {
                    ...
                    i.style.width = "";
                    i.style.height = "auto";
                    i.className += " CodeMirror-fullscreen";
                ...
                function r(e) {
                    ...
                    window.scrollTo(r.scrollLeft, r.scrollTop);
                    e.refresh()
                }

                e.defineOption("fullScreen", !1, function (n, o, t) {
                    t == e.Init && (t = !1);
                    !t != !o && (o ? i(n) : r(n))
                })
            })
        }, {codemirror: void 0}], 7: [function (i, r, n) {
            (function (o) {
                "object" == typeof n && "object" == typeof r ? o(function () {
                    try {
                        return i("codemirror")
                ...
                function i(e, i, n, o) {
                    var t = e.getLineHandle(i.line), p = i.ch - 1, l = p >= 0 && a[t.text.charAt(p)] || a[t.text.charAt(++p)];
                    if (!l)return null;
                    var E = ">" == l.charAt(1) ? 1 : -1;
                    if (n && E > 0 != (p == i.ch))return null;
                    var u = e.getTokenTypeAt(s(i.line, p + 1)), c = r(e, s(i.line, p + (E > 0 ? 1 : 0)), E, u || null, o);
                    return null == c ? null : {
                        from: s(i.line, p),
                        to: c && c.pos,
                        match: c && c.ch == l.charAt(0),
                        forward: E > 0
                    }
                }

                function r(e, i, r, n, o) {
                    for (var t = o && o.maxScanLineLength || 1e4, p = o && o.maxScanLines || 1e3, l = [], E = o && o.bracketRegex ? o.bracketRegex : /[(){}[\]]/, u = r > 0 ? Math.min(i.line + p, e.lastLine() + 1) : Math.max(e.firstLine() - 1, i.line - p), c = i.line; c != u; c += r) {
                        var d = e.getLine(c);
                        if (d) {
                            var N = r > 0 ? 0 : d.length - 1, I = r > 0 ? d.length : -1;
                            if (!(d.length > t)) {
                                c == i.line && (N = i.ch - (0 > r ? 1 : 0));
                                for (; N != I; N += r) {
                                    var x = d.charAt(N);
                                    if (E.test(x) && (void 0 === n || e.getTokenTypeAt(s(c, N + 1)) == n)) {
                                        var m = a[x];
                                        if (">" == m.charAt(1) == r > 0)l.push(x); else {
                                            if (!l.length)return {pos: s(c, N), ch: x};
                                            l.pop()
                                        }
                                    }
                                }
                    ...
                    return c - r == (r > 0 ? e.lastLine() : e.firstLine()) ? !1 : null
                }

                function n(e, r, n) {
                    for (var o = e.state.matchBrackets.maxHighlightLineLength || 1e3, a = [], p = e.listSelections(), l = 0; l < p.length; l++) {
                        var E = p[l].empty() && i(e, p[l].head, !1, n);
                        if (E && e.getLine(E.from.line).length <= o) {
                            var u = E.match ? "CodeMirror-matchingbracket" : "CodeMirror-nonmatchingbracket";
                            a.push(e.markText(E.from, s(E.from.line, E.from.ch + 1), {className: u}));
                            E.to && e.getLine(E.to.line).length <= o && a.push(e.markText(E.to, s(E.to.line, E.to.ch + 1), {className: u}))
                        }
                    }
                    if (a.length) {
                ...
                function o(e) {
                    e.operation(function () {
                        ...
                        p = n(e, !1, e.state.matchBrackets)
                    })
                }

                var t = /MSIE \d/.test(navigator.userAgent) && (null == document.documentMode || document.documentMode < 8), s = e.Pos, a = {
                    "(": ")>",
                    ")": "(<",
                    "[": "]>",
                    "]": "[<",
                ...
                e.defineOption("matchBrackets", !1, function (i, r, n) {
                    n && n != e.Init && i.off("cursorActivity", o);
                    if (r) {
                        i.state.matchBrackets = "object" == typeof r ? r : {};
                        i.on("cursorActivity", o)
                    }
                });
                ...
                e.defineExtension("scanForBracket", function (e, i, n, o) {
                    return r(this, e, i, n, o)
                })
            })
        }, {codemirror: void 0}], 8: [function (i, r, n) {
            (function (o) {
                "object" == typeof n && "object" == typeof r ? o(function () {
                    try {
                        return i("codemirror")
                ...
                "use strict";
                e.registerHelper("fold", "brace", function (i, r) {
                    function n(n) {
                        for (var o = r.ch, p = 0; ;) {
                            var l = 0 >= o ? -1 : a.lastIndexOf(n, o - 1);
                            if (-1 != l) {
                                if (1 == p && l < r.ch)break;
                                t = i.getTokenTypeAt(e.Pos(s, l + 1));
                                if (!/^(comment|string)/.test(t))return l + 1;
                                o = l - 1
                            } else {
                                if (1 == p)break;
                                p = 1;
                    ...
                    var o, t, s = r.line, a = i.getLine(s), p = "{", l = "}", o = n("{");
                    if (null == o) {
                        p = "[", l = "]";
                        o = n("[")
                    }
                    if (null != o) {
                        var E, u, c = 1, d = i.lastLine();
                        e:for (var N = s; d >= N; ++N)for (var I = i.getLine(N), x = N == s ? o : 0; ;) {
                            var m = I.indexOf(p, x), L = I.indexOf(l, x);
                            0 > m && (m = I.length);
                            0 > L && (L = I.length);
                            x = Math.min(m, L);
                            if (x == I.length)break;
                            if (i.getTokenTypeAt(e.Pos(N, x + 1)) == t)if (x == m)++c; else if (!--c) {
                                E = N;
                                u = x;
                                break e
                            }
                        ...
                        if (null != E && (s != E || u != o))return {from: e.Pos(s, o), to: e.Pos(E, u)}
                    }
                });
                e.registerHelper("fold", "import", function (i, r) {
                    function n(r) {
                        if (r < i.firstLine() || r > i.lastLine())return null;
                        var n = i.getTokenAt(e.Pos(r, 1));
                        /\S/.test(n.string) || (n = i.getTokenAt(e.Pos(r, n.end + 1)));
                        if ("keyword" != n.type || "import" != n.string)return null;
                        for (var o = r, t = Math.min(i.lastLine(), r + 10); t >= o; ++o) {
                            var s = i.getLine(o), a = s.indexOf(";");
                            if (-1 != a)return {startCh: n.end, end: e.Pos(o, a)}
                        }
                    }

                    var o, r = r.line, t = n(r);
                    if (!t || n(r - 1) || (o = n(r - 2)) && o.end.line == r - 1)return null;
                    for (var s = t.end; ;) {
                        var a = n(s.line + 1);
                        if (null == a)break;
                        s = a.end
                    }
                    return {from: i.clipPos(e.Pos(r, t.startCh + 1)), to: s}
                });
                e.registerHelper("fold", "include", function (i, r) {
                    function n(r) {
                        if (r < i.firstLine() || r > i.lastLine())return null;
                        var n = i.getTokenAt(e.Pos(r, 1));
                        /\S/.test(n.string) || (n = i.getTokenAt(e.Pos(r, n.end + 1)));
                        return "meta" == n.type && "#include" == n.string.slice(0, 8) ? n.start + 8 : void 0
                    }

                    var r = r.line, o = n(r);
                    if (null == o || null != n(r - 1))return null;
                    for (var t = r; ;) {
                        var s = n(t + 1);
                        if (null == s)break;
                        ++t
                    }
                    return {from: e.Pos(r, o + 1), to: i.clipPos(e.Pos(t))}
                })
            })
        }, {codemirror: void 0}], 9: [function (i, r, n) {
            (function (o) {
                "object" == typeof n && "object" == typeof r ? o(function () {
                    try {
                        return i("codemirror")
                ...
                function i(i, o, t, s) {
                    function a(e) {
                        ...
                        for (var n = i.findMarksAt(r.from), t = 0; t < n.length; ++t)if (n[t].__isFold && "fold" !== s) {
                            if (!e)return null;
                            r.cleared = !0;
                            n[t].clear()
                        }
                    ...
                    if (t && t.call) {
                        var p = t;
                        t = null
                    } else var p = n(i, t, "rangeFinder");
                    "number" == typeof o && (o = e.Pos(o, 0));
                    var l = n(i, t, "minFoldSize"), E = a(!0);
                    if (n(i, t, "scanUp"))for (; !E && o.line > i.firstLine();) {
                        o = e.Pos(o.line - 1, 0);
                        E = a(!1)
                    }
                    if (E && !E.cleared && "unfold" !== s) {
                        var u = r(i, t);
                        e.on(u, "mousedown", function (i) {
                            c.clear();
                            e.e_preventDefault(i)
                        });
                        var c = i.markText(E.from, E.to, {replacedWith: u, clearOnEnter: !0, __isFold: !0});
                        c.on("clear", function (r, n) {
                            e.signal(i, "unfold", i, r, n)
                        });
                        e.signal(i, "fold", i, E.from, E.to)
                    }
                }
                ...
                function n(e, i, r) {
                    ...
                    var n = e.options.foldOptions;
                    return n && void 0 !== n[r] ? n[r] : o[r]
                }

                e.newFoldFunction = function (e, r) {
                    return function (n, o) {
                        i(n, o, {rangeFinder: e, widget: r})
                    }
                };
                ...
                e.defineExtension("isFolded", function (e) {
                    for (var i = this.findMarksAt(e), r = 0; r < i.length; ++r)if (i[r].__isFold)return !0
                });
                ...
                e.commands.foldAll = function (i) {
                    i.operation(function () {
                        for (var r = i.firstLine(), n = i.lastLine(); n >= r; r++)i.foldCode(e.Pos(r, 0), null, "fold")
                    })
                };
                e.commands.unfoldAll = function (i) {
                    i.operation(function () {
                        for (var r = i.firstLine(), n = i.lastLine(); n >= r; r++)i.foldCode(e.Pos(r, 0), null, "unfold")
                    })
                };
                ...
                e.registerHelper("fold", "auto", function (e, i) {
                    for (var r = e.getHelpers(i, "fold"), n = 0; n < r.length; n++) {
                        var o = r[n](e, i);
                        if (o)return o
                    }
                });
                var o = {rangeFinder: e.fold.auto, widget: "↔", minFoldSize: 0, scanUp: !1};
                e.defineOption("foldOptions", null);
                e.defineExtension("foldOption", function (e, i) {
                    return n(this, e, i)
                })
            })
        }, {codemirror: void 0}], 10: [function (i, r, n) {
            (function (o) {
                "object" == typeof n && "object" == typeof r ? o(function () {
                    try {
                        return i("codemirror")
                ...
                }(), i("./foldcode")) : "function" == typeof e && e.amd ? e(["../../lib/codemirror", "./foldcode"], o) : o(CodeMirror)
            })(function (e) {
                "use strict";
                function i(e) {
                    this.options = e;
                ...
                function n(e, i) {
                    for (var r = e.findMarksAt(u(i)), n = 0; n < r.length; ++n)if (r[n].__isFold && r[n].find().from.line == i)return !0
                }

                function o(e) {
                    if ("string" == typeof e) {
                        var i = document.createElement("div");
                        i.className = e + " CodeMirror-guttermarker-subtle";
                        return i
                    }
                ...
                function t(e, i, r) {
                    var t = e.state.foldGutter.options, s = i, a = e.foldOption(t, "minFoldSize"), p = e.foldOption(t, "rangeFinder");
                    e.eachLine(i, r, function (i) {
                        var r = null;
                        if (n(e, s))r = o(t.indicatorFolded); else {
                            var l = u(s, 0), E = p && p(e, l);
                            E && E.to.line - E.from.line >= a && (r = o(t.indicatorOpen))
                        }
                        e.setGutterMarker(i, t.gutter, r);
                        ++s
                    })
                }

                function s(e) {
                    var i = e.getViewport(), r = e.state.foldGutter;
                    if (r) {
                        e.operation(function () {
                            t(e, i.from, i.to)
                        });
                ...
                function a(e, i, r) {
                    ...
                    r == n.gutter && e.foldCode(u(i, 0), n.rangeFinder)
                }

                function p(e) {
                    var i = e.state.foldGutter, r = e.state.foldGutter.options;
                    i.from = i.to = 0;
                    clearTimeout(i.changeUpdate);
                    i.changeUpdate = setTimeout(function () {
                        s(e)
                ...
                function l(e) {
                    ...
                    i.changeUpdate = setTimeout(function () {
                        var r = e.getViewport();
                        i.from == i.to || r.from - i.to > 20 || i.from - r.to > 20 ? s(e) : e.operation(function () {
                            if (r.from < i.from) {
                                t(e, r.from, i.from);
                                i.from = r.from
                            }
                ...
                function E(e, i) {
                    var r = e.state.foldGutter, n = i.line;
                    n >= r.from && n < r.to && t(e, n, n + 1)
                }

                e.defineOption("foldGutter", !1, function (n, o, t) {
                    if (t && t != e.Init) {
                        n.clearGutter(n.state.foldGutter.options.gutter);
                        n.state.foldGutter = null;
                        n.off("gutterClick", a);
                        n.off("change", p);
                        n.off("viewportChange", l);
                        n.off("fold", E);
                        n.off("unfold", E);
                        n.off("swapDoc", s)
                    }
                    if (o) {
                        n.state.foldGutter = new i(r(o));
                        s(n);
                        n.on("gutterClick", a);
                        n.on("change", p);
                        n.on("viewportChange", l);
                        n.on("fold", E);
                        n.on("unfold", E);
                        n.on("swapDoc", s)
                    }
        ...
        }, {"./foldcode": 9, codemirror: void 0}], 11: [function (i, r, n) {
            (function (o) {
                "object" == typeof n && "object" == typeof r ? o(function () {
                    try {
                        return i("codemirror")
                ...
                function r(e, i, r, n) {
                    ...
                    this.ch = r;
                    this.cm = e;
                    this.text = e.getLine(i);
                    this.min = n ? n.from : e.firstLine();
                    this.max = n ? n.to - 1 : e.lastLine()
                }

                function n(e, i) {
                    var r = e.cm.getTokenTypeAt(c(e.line, i));
                ...
                function s(e) {
                    for (; ;) {
                        var i = e.text.indexOf(">", e.ch);
                        if (-1 == i) {
                            if (o(e))continue;
                            return
                        }
                        if (n(e, i + 1)) {
                            var r = e.text.lastIndexOf("/", i), t = r > -1 && !/\S/.test(e.text.slice(r + 1, i));
                            e.ch = i + 1;
                            return t ? "selfClose" : "regular"
                        }
                        e.ch = i + 1
                    }
                }
                ...
                function a(e) {
                    for (; ;) {
                        var i = e.ch ? e.text.lastIndexOf("<", e.ch - 1) : -1;
                        if (-1 == i) {
                            if (t(e))continue;
                            return
                        }
                ...
                function l(e) {
                    for (; ;) {
                        ...
                        if (n(e, i + 1)) {
                            var r = e.text.lastIndexOf("/", i), o = r > -1 && !/\S/.test(e.text.slice(r + 1, i));
                            e.ch = i + 1;
                            return o ? "selfClose" : "regular"
                        }
                        e.ch = i
                    }
                }
                ...
                function E(e, i) {
                    for (var r = []; ;) {
                        var n, o = p(e), t = e.line, a = e.ch - (o ? o[0].length : 0);
                        if (!o || !(n = s(e)))return;
                        if ("selfClose" != n)if (o[1]) {
                            for (var l = r.length - 1; l >= 0; --l)if (r[l] == o[2]) {
                                r.length = l;
                                break
                            }
                            if (0 > l && (!i || i == o[2]))return {tag: o[2], from: c(t, a), to: c(e.line, e.ch)}
                        } else r.push(o[2])
                    }
                }
                ...
                function u(e, i) {
                    for (var r = []; ;) {
                        ...
                        if (!n)return;
                        if ("selfClose" != n) {
                            var o = e.line, t = e.ch, s = a(e);
                            if (!s)return;
                            if (s[1])r.push(s[2]); else {
                                for (var p = r.length - 1; p >= 0; --p)if (r[p] == s[2]) {
                                    r.length = p;
                                    break
                                }
                                if (0 > p && (!i || i == s[2]))return {tag: s[2], from: c(e.line, e.ch), to: c(o, t)}
                            }
                        } else a(e)
                    }
                }

                var c = e.Pos, d = "A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD", N = d + "-:.0-9\\u00B7\\u0300-\\u036F\\u203F-\\u2040", I = new RegExp("<(/?)([" + d + "][" + N + "]*)", "g");
                e.registerHelper("fold", "xml", function (e, i) {
                    for (var n = new r(e, i.line, 0); ;) {
                        var o, t = p(n);
                        if (!t || n.line != i.line || !(o = s(n)))return;
                        if (!t[1] && "selfClose" != o) {
                            var i = c(n.line, n.ch), a = E(n, t[2]);
                            return a && {from: i, to: a.from}
                        }
                    }
                });
                e.findMatchingTag = function (e, n, o) {
                    var t = new r(e, n.line, n.ch, o);
                    if (-1 != t.text.indexOf(">") || -1 != t.text.indexOf("<")) {
                        var p = s(t), l = p && c(t.line, t.ch), d = p && a(t);
                        if (p && d && !(i(t, n) > 0)) {
                            var N = {from: c(t.line, t.ch), to: l, tag: d[2]};
                            if ("selfClose" == p)return {open: N, close: null, at: "open"};
                            if (d[1])return {open: u(t, d[2]), close: N, at: "close"};
                            t = new r(e, l.line, l.ch, o);
                            return {open: N, close: E(t, d[2]), at: "open"}
                        }
                    }
                };
                e.findEnclosingTag = function (e, i, n) {
                    for (var o = new r(e, i.line, i.ch, n); ;) {
                        var t = u(o);
                        if (!t)break;
                        var s = new r(e, i.line, i.ch, n), a = E(s, t.tag);
                        if (a)return {open: t, close: a}
                    }
                };
                e.scanForClosingTag = function (e, i, n, o) {
                    var t = new r(e, i.line, i.ch, o ? {from: 0, to: o} : null);
                    return E(t, n)
                }
            })
        }, {codemirror: void 0}], 12: [function (i, r, n) {
            (function (o) {
                "object" == typeof n && "object" == typeof r ? o(function () {
                    try {
                        return i("codemirror")
                ...
                function i(e, i) {
                    this.cm = e;
                    this.options = this.buildOptions(i);
                ...
                function o(e, i) {
                    for (; i && i != e;) {
                        if ("LI" === i.nodeName.toUpperCase() && i.parentNode == e)return i;
                        i = i.parentNode
                    }
                }
                ...
                function t(i, t) {
                    this.completion = i;
                    this.data = t;
                    var p = this, l = i.cm, E = this.hints = document.createElement("ul");
                    E.className = "CodeMirror-hints";
                    this.selectedHint = t.selectedHint || 0;
                    for (var u = t.list, c = 0; c < u.length; ++c) {
                        var d = E.appendChild(document.createElement("li")), N = u[c], I = s + (c != this.selectedHint ? "" : " " + a);
                        null != N.className && (I = N.className + " " + I);
                        d.className = I;
                        N.render ? N.render(d, t, N) : d.appendChild(document.createTextNode(N.displayText || r(N)));
                        d.hintId = c
                    }
                    var x = l.cursorCoords(i.options.alignWithWord ? t.from : null), m = x.left, L = x.bottom, T = !0;
                    E.style.left = m + "px";
                    E.style.top = L + "px";
                    var A = window.innerWidth || Math.max(document.body.offsetWidth, document.documentElement.offsetWidth), g = window.innerHeight || Math.max(document.body.offsetHeight, document.documentElement.offsetHeight);
                    (i.options.container || document.body).appendChild(E);
                    var S = E.getBoundingClientRect(), R = S.bottom - g;
                    if (R > 0) {
                        var v = S.bottom - S.top, h = x.top - (x.bottom - S.top);
                        if (h - v > 0) {
                            E.style.top = (L = x.top - v) + "px";
                            T = !1
                        } else if (v > g) {
                            E.style.height = g - 5 + "px";
                            E.style.top = (L = x.bottom - S.top) + "px";
                            var C = l.getCursor();
                            if (t.from.ch != C.ch) {
                                x = l.cursorCoords(C);
                                E.style.left = (m = x.left) + "px";
                    ...
                    if (f > 0) {
                        if (S.right - S.left > A) {
                            E.style.width = A - 5 + "px";
                            f -= S.right - S.left - A
                        }
                        E.style.left = (m = x.left - f) + "px"
                    }
                    l.addKeyMap(this.keyMap = n(i, {
                        moveFocus: function (e, i) {
                            p.changeActive(p.selectedHint + e, i)
                        }, setFocus: function (e) {
                            p.changeActive(e)
                        }, menuSize: function () {
                            return p.screenAmount()
                    ...
                    var y = l.getScrollInfo();
                    l.on("scroll", this.onScroll = function () {
                        var e = l.getScrollInfo(), r = l.getWrapperElement().getBoundingClientRect(), n = L + y.top - e.top, o = n - (window.pageYOffset || (document.documentElement || document.body).scrollTop);
                        T || (o += E.offsetHeight);
                        if (o <= r.top || o >= r.bottom)return i.close();
                        E.style.top = n + "px";
                        E.style.left = m + y.left - e.left + "px"
                    });
                    e.on(E, "dblclick", function (e) {
                        var i = o(E, e.target || e.srcElement);
                        if (i && null != i.hintId) {
                            p.changeActive(i.hintId);
                            p.pick()
                        }
                    });
                    e.on(E, "click", function (e) {
                        var r = o(E, e.target || e.srcElement);
                        if (r && null != r.hintId) {
                            p.changeActive(r.hintId);
                            i.options.completeOnSingleClick && p.pick()
                        }
                    });
                    e.on(E, "mousedown", function () {
                        setTimeout(function () {
                            l.focus()
                        }, 20)
                    });
                    e.signal(t, "select", u[0], E.firstChild);
                    return !0
                }

                var s = "CodeMirror-hint", a = "CodeMirror-hint-active";
                e.showHint = function (e, i, r) {
                    if (!i)return e.showHint(r);
                    r && r.async && (i.async = !0);
                    var n = {hint: i};
                ...
                e.defineExtension("showHint", function (r) {
                    if (!(this.listSelections().length > 1 || this.somethingSelected())) {
                        ...
                        var n = this.state.completionActive = new i(this, r), o = n.options.hint;
                        if (o) {
                            e.signal(this, "startCompletion", this);
                            if (!o.async)return n.showHints(o(this, n.options));
                            o(this, function (e) {
                                n.showHints(e)
                            }, n.options);
                            return void 0
                ...
                i.prototype = {
                    close: function () {
                        ...
                        var o = i.list[n];
                        o.hint ? o.hint(this.cm, i, o) : this.cm.replaceRange(r(o), o.from || i.from, o.to || i.to, "complete");
                        e.signal(i, "pick", o);
                        this.close()
                        ...
                        function n() {
                            if (!p) {
                                e.signal(i, "update");
                                var r = E.options.hint;
                                r.async ? r(E.cm, o, E.options) : o(r(E.cm, E.options))
                            }
                        }
                        ...
                        function o(e) {
                            i = e;
                            if (!p) {
                                if (!i || !i.list.length)return r();
                                E.widget && E.widget.close();
                                E.widget = new t(E, i)
                            }
                        }
                        ...
                        function a() {
                            s();
                            var e = E.cm.getCursor(), i = E.cm.getLine(e.line);
                            if (e.line != c.line || i.length - e.ch != d - c.ch || e.ch < c.ch || E.cm.somethingSelected() || e.ch && u.test(i.charAt(e.ch - 1)))E.close(); else {
                                l = N(n);
                                E.widget && E.widget.close()
                            }
                        }

                        this.widget = new t(this, i);
                        e.signal(i, "shown");
                        var p, l = 0, E = this, u = this.options.closeCharacters, c = this.cm.getCursor(), d = this.cm.getLine(c.line).length, N = window.requestAnimationFrame || function (e) {
                                return setTimeout(e, 1e3 / 60)
                            }, I = window.cancelAnimationFrame || clearTimeout;
                        this.cm.on("cursorActivity", a);
                        this.onClose = r
                    }, buildOptions: function (e) {
                        var i = this.cm.options.hintOptions, r = {};
                        for (var n in p)r[n] = p[n];
                        if (i)for (var n in i)void 0 !== i[n] && (r[n] = i[n]);
                        if (e)for (var n in e)void 0 !== e[n] && (r[n] = e[n]);
                        return r
                    }
                };
                t.prototype = {
                    close: function () {
                        ...
                        i >= this.data.list.length ? i = r ? this.data.list.length - 1 : 0 : 0 > i && (i = r ? 0 : this.data.list.length - 1);
                        if (this.selectedHint != i) {
                            var n = this.hints.childNodes[this.selectedHint];
                            n.className = n.className.replace(" " + a, "");
                            n = this.hints.childNodes[this.selectedHint = i];
                            n.className += " " + a;
                ...
                e.registerHelper("hint", "auto", function (i, r) {
                    var n, o = i.getHelpers(i.getCursor(), "hint");
                    if (o.length)for (var t = 0; t < o.length; t++) {
                        var s = o[t](i, r);
                        if (s && s.list.length)return s
                    } else if (n = i.getHelper(i.getCursor(), "hintWords")) {
                        if (n)return e.hint.fromList(i, {words: n})
                    } else if (e.hint.anyword)return e.hint.anyword(i, r)
                });
                e.registerHelper("hint", "fromList", function (i, r) {
                    for (var n = i.getCursor(), o = i.getTokenAt(n), t = [], s = 0; s < r.words.length; s++) {
                        var a = r.words[s];
                        a.slice(0, o.string.length) == o.string && t.push(a)
                    }
                    return t.length ? {list: t, from: e.Pos(n.line, o.start), to: e.Pos(n.line, o.end)} : void 0
                });
        ...
        }, {codemirror: void 0}], 13: [function (i, r, n) {
            (function (o) {
                "object" == typeof n && "object" == typeof r ? o(function () {
                    try {
                        return i("codemirror")
                ...
                "use strict";
                e.runMode = function (i, r, n, o) {
                    var t = e.getMode(e.defaults, r), s = /MSIE \d/.test(navigator.userAgent), a = s && (null == document.documentMode || document.documentMode < 9);
                    if (1 == n.nodeType) {
                        var p = o && o.tabSize || e.defaults.tabSize, l = n, E = 0;
                        l.innerHTML = "";
                        n = function (e, i) {
                            if ("\n" != e) {
                                for (var r = "", n = 0; ;) {
                                ...
                                if (i) {
                                    var u = l.appendChild(document.createElement("span"));
                                    u.className = "cm-" + i.replace(/ +/g, " cm-");
                                    u.appendChild(document.createTextNode(r))
                                } else l.appendChild(document.createTextNode(r))
                            } else {
                                l.appendChild(document.createTextNode(a ? "\r" : e));
                                E = 0
                            }
                        }
                    }
                    for (var u = e.splitLines(i), c = o && o.state || e.startState(t), d = 0, N = u.length; N > d; ++d) {
                        d && n("\n");
                        var I = new e.StringStream(u[d]);
                        !I.string && t.blankLine && t.blankLine(c);
                        for (; !I.eol();) {
                            var x = t.token(I, c);
                            n(I.current(), x, d, I.start, c);
                            I.start = I.pos
                        }
                    }
                }
            })
        }, {codemirror: void 0}], 14: [function (i, r, n) {
            (function (o) {
                "object" == typeof n && "object" == typeof r ? o(function () {
                    try {
                        return i("codemirror")
                ...
                function i(e, i, o, t) {
                    this.atOccurrence = !1;
                    this.doc = e;
                    null == t && "string" == typeof i && (t = !1);
                    o = o ? e.clipPos(o) : n(0, 0);
                    this.pos = {from: o, to: o};
                    if ("string" != typeof i) {
                        i.global || (i = new RegExp(i.source, i.ignoreCase ? "ig" : "g"));
                        this.matches = function (r, o) {
                            if (r) {
                                i.lastIndex = 0;
                                for (var t, s, a = e.getLine(o.line).slice(0, o.ch), p = 0; ;) {
                                    i.lastIndex = p;
                                    var l = i.exec(a);
                                    if (!l)break;
                                    t = l;
                                    s = t.index;
                                    p = t.index + (t[0].length || 1);
                                    if (p == a.length)break
                                }
                                var E = t && t[0].length || 0;
                                E || (0 == s && 0 == a.length ? t = void 0 : s != e.getLine(o.line).length && E++)
                            } else {
                                i.lastIndex = o.ch;
                                var a = e.getLine(o.line), t = i.exec(a), E = t && t[0].length || 0, s = t && t.index;
                                s + E == a.length || E || (E = 1)
                            }
                            return t && E ? {from: n(o.line, s), to: n(o.line, s + E), match: t} : void 0
                        }
                    } else {
                        var s = i;
                        t && (i = i.toLowerCase());
                        ...
                        if (1 == p.length)this.matches = i.length ? function (o, t) {
                            if (o) {
                                var p = e.getLine(t.line).slice(0, t.ch), l = a(p), E = l.lastIndexOf(i);
                                if (E > -1) {
                                    E = r(p, l, E);
                                    return {from: n(t.line, E), to: n(t.line, E + s.length)}
                                }
                            } else {
                                var p = e.getLine(t.line).slice(t.ch), l = a(p), E = l.indexOf(i);
                                if (E > -1) {
                                    E = r(p, l, E) + t.ch;
                                    return {from: n(t.line, E), to: n(t.line, E + s.length)}
                                }
                            ...
                            this.matches = function (i, r) {
                                var o = p.length - 1;
                                if (i) {
                                    if (r.line - (p.length - 1) < e.firstLine())return;
                                    if (a(e.getLine(r.line).slice(0, l[o].length)) != p[p.length - 1])return;
                                    for (var t = n(r.line, l[o].length), s = r.line - 1, E = o - 1; E >= 1; --E, --s)if (p[E] != a(e.getLine(s)))return;
                                    var u = e.getLine(s), c = u.length - l[0].length;
                                    if (a(u.slice(c)) != p[0])return;
                                    return {from: n(s, c), to: t}
                                }
                                if (!(r.line + (p.length - 1) > e.lastLine())) {
                                    var u = e.getLine(r.line), c = u.length - l[0].length;
                                    if (a(u.slice(c)) == p[0]) {
                                        for (var d = n(r.line, c), s = r.line + 1, E = 1; o > E; ++E, ++s)if (p[E] != a(e.getLine(s)))return;
                                        if (a(e.getLine(s).slice(0, l[o].length)) == p[o])return {
                                            from: d,
                                            to: n(s, l[o].length)
                                        }
                                    }
                ...
                i.prototype = {
                    findNext: function () {
                        ...
                        for (var r = this, o = this.doc.clipPos(e ? this.pos.from : this.pos.to); ;) {
                            ...
                            if (e) {
                                if (!o.line)return i(0);
                                o = n(o.line - 1, this.doc.getLine(o.line - 1).length)
                            } else {
                                var t = this.doc.lineCount();
                                if (o.line == t - 1)return i(t);
                                o = n(o.line + 1, 0)
                            }
                        }
                    }, from: function () {
                        ...
                        if (this.atOccurrence) {
                            var r = e.splitLines(i);
                            this.doc.replaceRange(r, this.pos.from, this.pos.to);
                            this.pos.to = n(this.pos.from.line + r.length - 1, r[r.length - 1].length + (1 == r.length ? this.pos.from.ch : 0))
                        }
                    }
                };
                e.defineExtension("getSearchCursor", function (e, r, n) {
                    return new i(this.doc, e, r, n)
                });
                e.defineDocExtension("getSearchCursor", function (e, r, n) {
                    return new i(this, e, r, n)
                });
                e.defineExtension("selectMatches", function (i, r) {
                    for (var n, o = [], t = this.getSearchCursor(i, this.getCursor("from"), r); (n = t.findNext()) && !(e.cmpPos(t.to(), this.getCursor("to")) > 0);)o.push({
                        anchor: t.from(),
                        head: t.to()
                    });
        ...
        }, {codemirror: void 0}], 15: [function (i, r) {
            (function (i) {
                function n() {
                    try {
                        return p in i && i[p]
                ...
                function o(e) {
                    return e.replace(/^d/, "___$&").replace(N, "___")
                }

                var t, s = {}, a = i.document, p = "localStorage", l = "script";
                s.disabled = !1;
                s.version = "1.3.17";
                s.set = function () {
                };
                ...
                s.has = function (e) {
                    return void 0 !== s.get(e)
                };
                s.remove = function () {
                };
                s.clear = function () {
                };
                s.transact = function (e, i, r) {
                    if (null == r) {
                        r = i;
                        i = null
                    }
                ...
                if (n()) {
                    ...
                    s.set = function (e, i) {
                        ...
                        t.setItem(e, s.serialize(i));
                        return i
                    };
                    s.get = function (e, i) {
                        var r = s.deserialize(t.getItem(e));
                        return void 0 === r ? i : r
                    };
                    s.remove = function (e) {
                        t.removeItem(e)
                    ...
                    try {
                        ...
                        u.open();
                        u.write("<" + l + ">document.w=window</" + l + '><iframe src="/favicon.ico"></iframe>');
                        u.close();
                        E = u.w.frames[0].document;
                    ...
                    s.set = d(function (e, i, r) {
                        i = o(i);
                        if (void 0 === r)return s.remove(i);
                        e.setAttribute(i, s.serialize(r));
                        e.save(p);
                        return r
                    });
                    s.get = d(function (e, i, r) {
                        i = o(i);
                        var n = s.deserialize(e.getAttribute(i));
                        return void 0 === n ? r : n
                    });
                    s.remove = d(function (e, i) {
                        i = o(i);
                        e.removeAttribute(i);
                        e.save(p)
                    });
                    s.clear = d(function (e) {
                        var i = e.XMLDocument.documentElement.attributes;
                        e.load(p);
                        for (var r, n = 0; r = i[n]; n++)e.removeAttribute(r.name);
                        e.save(p)
                    });
                    s.getAll = function () {
                        var e = {};
                    ...
                    s.forEach = d(function (e, i) {
                        for (var r, n = e.XMLDocument.documentElement.attributes, o = 0; r = n[o]; ++o)i(r.name, s.deserialize(e.getAttribute(r.name)))
                    })
                }
                try {
                    var I = "__storejs__";
                    s.set(I, I);
                    s.get(I) != I && (s.disabled = !0);
                    s.remove(I)
                } catch (c) {
                    s.disabled = !0
                }
                s.enabled = !s.disabled;
                "undefined" != typeof r && r.exports && this.module !== r ? r.exports = s : "function" == typeof e && e.amd ? e(s) : i.store = s
            ...
            i.exports = {
                ...
                main: "src/main.js",
                repository: {type: "git", url: "git://github.com/YASGUI/Utils.git"},
                licenses: [{type: "MIT", url: "http://yasgui.github.io/license.txt"}],
                ...
                bugs: {url: "https://github.com/YASGUI/Utils/issues"},
                homepage: "https://github.com/YASGUI/Utils",
                dependencies: {store: "^1.3.14"}
            }
        }, {}], 17: [function (e, i) {
            ...
            i.exports = {
                storage: e("./storage.js"),
                svg: e("./svg.js"),
                version: {"yasgui-utils": e("../package.json").version},
                nestedExists: function (e) {
                    for (var i = Array.prototype.slice.call(arguments, 1), r = 0; r < i.length; r++) {
                        if (!e || !e.hasOwnProperty(i[r]))return !1;
                        e = e[i[r]]
                    }
                    return !0
                }
            }
        }, {"../package.json": 16, "./storage.js": 18, "./svg.js": 19}], 18: [function (e, i) {
            {
                var r = e("store"), n = {
                    day: function () {
                        return 864e5
                ...
                i.exports = {
                    set: function (e, i, o) {
                        if (r.enabled && e && void 0 !== i) {
                            "string" == typeof o && (o = n[o]());
                            i.documentElement && (i = (new XMLSerializer).serializeToString(i.documentElement));
                            r.set(e, {val: i, exp: o, time: (new Date).getTime()})
                        }
                    }, remove: function (e) {
                        r.enabled && e && r.remove(e)
                    }, get: function (e) {
                        if (!r.enabled)return null;
                        if (e) {
                            var i = r.get(e);
                            return i ? i.exp && (new Date).getTime() - i.time > i.exp ? null : i.val : null
                        }
                        return null
                    }
                }
            }
        }, {store: 15}], 19: [function (e, i) {
            i.exports = {
                draw: function (e, r) {
                    if (e) {
                        var n = i.exports.getElement(r);
                        n && (e.append ? e.append(n) : e.appendChild(n))
                    }
                }, getElement: function (e) {
                    if (e && 0 == e.indexOf("<svg")) {
                        var i = new DOMParser, r = i.parseFromString(e, "text/xml"), n = r.documentElement, o = document.createElement("div");
                        o.className = "svgImg";
                        o.appendChild(n);
                        return o
                    }
            ...
            i.exports = {
                ...
                version: "2.3.9",
                main: "src/main.js",
                licenses: [{type: "MIT", url: "http://yasqe.yasgui.org/license.txt"}],
                author: "Laurens Rietveld",
                ...
                keywords: ["JavaScript", "SPARQL", "Editor", "Semantic Web", "Linked Data"],
                maintainers: [{
                    name: "Laurens Rietveld",
                    email: "laurens.rietveld@gmail.com",
                    web: "http://laurensrietveld.nl"
                }],
                repository: {type: "git", url: "https://github.com/YASGUI/YASQE.git"},
                dependencies: {jquery: "~ 1.11.0", codemirror: "^4.7.0", "yasgui-utils": "^1.4.1"},
                optionalShim: {
                    codemirror: {require: "codemirror", global: "CodeMirror"},
                    jquery: {require: "jquery", global: "jQuery"},
                    "../../lib/codemirror": {require: "codemirror", global: "CodeMirror"}
                }
            }
        }, {}], 21: [function (e, i) {
            "use strict";
            ...
            }(), n = e("../utils.js"), o = e("yasgui-utils"), t = e("../../lib/trie.js");
            i.exports = function (e, i) {
                ...
                i.on("change", function () {
                    var e = [];
                    for (var n in a)a[n].is(":visible") && e.push(a[n]);
                    if (e.length > 0) {
                        var o = r(i.getWrapperElement()).find(".CodeMirror-vscrollbar"), t = 0;
                        o.is(":visible") && (t = o.outerWidth());
                ...
                var E = function (e, r) {
                    l[e.name] = new t;
                    for (var s = 0; s < r.length; s++)l[e.name].insert(r[s]);
                    var a = n.getPersistencyId(i, e.persistent);
                    a && o.storage.set(a, r, "month")
                }, u = function (e, r) {
                    var t = p[e] = new r(i, e);
                    t.name = e;
                    if (t.bulk) {
                        var s = function (e) {
                            e && e instanceof Array && e.length > 0 && E(t, e)
                        };
                        if (t.get instanceof Array)s(t.get); else {
                            var a = null, l = n.getPersistencyId(i, t.persistent);
                            l && (a = o.storage.get(l));
                            a && a.length > 0 ? s(a) : t.get instanceof Function && (t.async ? t.get(null, s) : s(t.get()))
                        }
                    }
                }, c = function (n) {
                    if (!i.somethingSelected()) {
                        var o = function (r) {
                            if (n && (!r.autoShow || !r.bulk && r.async))return !1;
                            var o = {closeCharacters: /(?=a)b/, completeSingle: !1};
                            !r.bulk && r.async && (o.async = !0);
                            {
                                var t = function (e, i) {
                                    return d(r, i)
                                };
                        ...
                        for (var t in p)if (-1 != r.inArray(t, i.options.autocompleters)) {
                            var s = p[t];
                            if (s.isValidCompletionPosition)if (s.isValidCompletionPosition()) {
                                if (!s.callbacks || !s.callbacks.validPosition || s.callbacks.validPosition(i, s) !== !1) {
                                    var a = o(s);
                                    if (a)break
                                }
                            } else s.callbacks && s.callbacks.invalidPosition && s.callbacks.invalidPosition(i, s)
                        }
                    }
                }, d = function (e, r) {
                    var n = function (i) {
                        var r = i.autocompletionString || i.string, n = [];
                        if (l[e.name])n = l[e.name].autoComplete(r); else if ("function" == typeof e.get && 0 == e.async)n = e.get(r); else if ("object" == typeof e.get)for (var o = r.length, t = 0; t < e.get.length; t++) {
                            var s = e.get[t];
                            s.slice(0, o) == r && n.push(s)
                        }
                        return N(n, e, i)
                    }, o = i.getCompleteToken();
                    e.preProcessToken && (o = e.preProcessToken(o));
                    if (o) {
                        if (e.bulk || !e.async)return n(o);
                        var t = function (i) {
                            r(N(i, e, o))
                        };
                        e.get(o, t)
                    ...
                    for (var o = [], t = 0; t < e.length; t++) {
                        var a = e[t];
                        r.postProcessToken && (a = r.postProcessToken(n, a));
                        o.push({text: a, displayText: a, hint: s})
                    }
                    var p = i.getCursor(), l = {
                        completionToken: n.string,
                        list: o,
                        from: {line: p.line, ch: n.start},
                        to: {line: p.line, ch: n.end}
                    };
                    if (r.callbacks)for (var E in r.callbacks)r.callbacks[E] && i.on(l, E, r.callbacks[E]);
                    return l
                };
                return {
                    init: u, completers: p, notifications: {
                        getEl: function (e) {
                            return r(a[e.name])
                        }, show: function (e, i) {
                            if (!i.autoshow) {
                                a[i.name] || (a[i.name] = r("<div class='completionNotification'></div>"));
                                a[i.name].show().text("Press " + (-1 != navigator.userAgent.indexOf("Mac OS X") ? "CMD" : "CTRL") + " - <spacebar> to autocomplete").appendTo(r(e.getWrapperElement()))
                            }
                        }, hide: function (e, i) {
                            a[i.name] && a[i.name].hide()
                        }
                    }, autoComplete: c, getTrie: function (e) {
                        return "string" == typeof e ? l[e] : l[e.name]
                    }
                }
            };
            var s = function (e, i, r) {
                r.text != e.getTokenAt(e.getCursor()).string && e.replaceRange(r.text, i.from, i.to)
            }
        }, {"../../lib/trie.js": 5, "../utils.js": 34, jquery: void 0, "yasgui-utils": 17}], 22: [function (e, i) {
            "use strict";
            (function () {
                try {
                    return e("jquery")
            ...
            i.exports = function (r, n) {
                return {
                    isValidCompletionPosition: function () {
                        return i.exports.isValidCompletionPosition(r)
                    },
                    get: function (i, n) {
                        return e("./utils").fetchFromLov(r, this, i, n)
                    },
                    preProcessToken: function (e) {
                        return i.exports.preProcessToken(r, e)
                    },
                    postProcessToken: function (e, n) {
                        return i.exports.postProcessToken(r, e, n)
                    },
                    async: !0,
                    bulk: !1,
                    autoShow: !1,
                    persistent: n,
                    callbacks: {
                        validPosition: r.autocompleters.notifications.show,
                        invalidPosition: r.autocompleters.notifications.hide
                    }
                }
            };
            i.exports.isValidCompletionPosition = function (e) {
                var i = e.getCompleteToken();
                if (0 == i.string.indexOf("?"))return !1;
                var r = e.getCursor(), n = e.getPreviousNonWsToken(r.line, i);
                return "a" == n.string ? !0 : "rdf:type" == n.string ? !0 : "rdfs:domain" == n.string ? !0 : "rdfs:range" == n.string ? !0 : !1
            };
            i.exports.preProcessToken = function (i, r) {
                return e("./utils.js").preprocessResourceTokenForCompletion(i, r)
            };
            i.exports.postProcessToken = function (i, r, n) {
                return e("./utils.js").postprocessResourceTokenForCompletion(i, r, n)
            }
        }, {"./utils": 25, "./utils.js": 25, jquery: void 0}], 23: [function (e, i) {
            "use strict";
            var r = function () {
                try {
                    return e("jquery")
            ...
            }(), n = {"string-2": "prefixed", atom: "var"};
            i.exports = function (e, n) {
                e.on("change", function () {
                    i.exports.appendPrefixIfNeeded(e, n)
                });
                return {
                    isValidCompletionPosition: function () {
                        return i.exports.isValidCompletionPosition(e)
                    }, get: function (e, i) {
                        r.get("http://prefix.cc/popular/all.file.json", function (e) {
                            var r = [];
                            for (var n in e)if ("bif" != n) {
                                var o = n + ": <" + e[n] + ">";
                                r.push(o)
                            }
                            r.sort();
                    ...
                    }, preProcessToken: function (r) {
                        return i.exports.preprocessPrefixTokenForCompletion(e, r)
                    }, async: !0, bulk: !0, autoShow: !0, persistent: n
                }
            };
            i.exports.isValidCompletionPosition = function (e) {
                var i = e.getCursor(), n = e.getTokenAt(i);
                if (e.getLine(i.line).length > i.ch)return !1;
                "ws" != n.type && (n = e.getCompleteToken());
                if (0 == !n.string.indexOf("a") && -1 == r.inArray("PNAME_NS", n.state.possibleCurrent))return !1;
                var o = e.getPreviousNonWsToken(i.line, n);
                return o && "PREFIX" == o.string.toUpperCase() ? !0 : !1
            };
            i.exports.preprocessPrefixTokenForCompletion = function (e, i) {
                var r = e.getPreviousNonWsToken(e.getCursor().line, i);
                r && r.string && ":" == r.string.slice(-1) && (i = {
                    start: r.start,
                    end: i.end,
                    string: r.string + " " + i.string,
                    state: i.state
                });
                return i
            };
            i.exports.appendPrefixIfNeeded = function (e, i) {
                if (e.autocompleters.getTrie(i) && e.options.autocompleters && -1 != e.options.autocompleters.indexOf(i)) {
                    var r = e.getCursor(), o = e.getTokenAt(r);
                    if ("prefixed" == n[o.type]) {
                        var t = o.string.indexOf(":");
                        if (-1 !== t) {
                            var s = e.getPreviousNonWsToken(r.line, o).string.toUpperCase(), a = e.getTokenAt({
                                line: r.line,
                                ch: o.start
                            });
                            if ("PREFIX" != s && ("ws" == a.type || null == a.type)) {
                                var p = o.string.substring(0, t + 1), l = e.getPrefixesFromQuery();
                                if (null == l[p.slice(0, -1)]) {
                                    var E = e.autocompleters.getTrie(i).autoComplete(p);
                                    E.length > 0 && e.addPrefixes(E[0])
                                }
                            }
                        }
                    }
            ...
            i.exports.isValidCompletionPosition = function (e) {
                var i = e.getCompleteToken();
                if (0 == i.string.length)return !1;
                if (0 == i.string.indexOf("?"))return !1;
                if (r.inArray("a", i.state.possibleCurrent) >= 0)return !0;
                var n = e.getCursor(), o = e.getPreviousNonWsToken(n.line, i);
                return "rdfs:subPropertyOf" == o.string ? !0 : !1
            };
            i.exports.preProcessToken = function (i, r) {
                return e("./utils.js").preprocessResourceTokenForCompletion(i, r)
            };
        ...
        }, {"./utils": 25, "./utils.js": 25, jquery: void 0}], 25: [function (e, i) {
            "use strict";
            var r = function () {
                try {
                    return e("jquery")
            ...
            }(), n = (e("./utils.js"), e("yasgui-utils")), o = function (e, i) {
                var r = e.getPrefixesFromQuery();
                if (0 == !i.string.indexOf("<")) {
                    i.tokenPrefix = i.string.substring(0, i.string.indexOf(":") + 1);
                    null != r[i.tokenPrefix.slice(0, -1)] && (i.tokenPrefixUri = r[i.tokenPrefix.slice(0, -1)])
                }
                i.autocompletionString = i.string.trim();
                if (0 == !i.string.indexOf("<") && i.string.indexOf(":") > -1)for (var n in r)if (0 == i.string.indexOf(n)) {
                    i.autocompletionString = r[n];
                    i.autocompletionString += i.string.substring(n.length + 1);
                    break
                }
                0 == i.autocompletionString.indexOf("<") && (i.autocompletionString = i.autocompletionString.substring(1));
                -1 !== i.autocompletionString.indexOf(">", i.length - 1) && (i.autocompletionString = i.autocompletionString.substring(0, i.autocompletionString.length - 1));
                return i
            }, t = function (e, i, r) {
                r = i.tokenPrefix && i.autocompletionString && i.tokenPrefixUri ? i.tokenPrefix + r.substring(i.tokenPrefixUri.length) : "<" + r + ">";
                return r
            }, s = function (i, o, t, s) {
                if (!t || !t.string || 0 == t.string.trim().length) {
                    i.autocompleters.notifications.getEl(o).empty().append("Nothing to autocomplete yet!");
                    return !1
                }
                var a = 50, p = {q: t.autocompletionString, page: 1};
                p.type = "classes" == o.name ? "class" : "property";
                var l = [], E = "", u = function () {
                    E = "http://lov.okfn.org/dataset/lov/api/v2/autocomplete/terms?" + r.param(p)
                };
                u();
                var c = function () {
                    p.page++;
                    ...
                    r.get(E, function (e) {
                        for (var n = 0; n < e.results.length; n++)l.push(r.isArray(e.results[n].uri) && e.results[n].uri.length > 0 ? e.results[n].uri[0] : e.results[n].uri);
                        if (l.length < e.total_results && l.length < a) {
                            c();
                            d()
                        } else {
                            l.length > 0 ? i.autocompleters.notifications.hide(i, o) : i.autocompleters.notifications.getEl(o).text("0 matches found...");
                            s(l)
                        }
                    }).fail(function () {
                        i.autocompleters.notifications.getEl(o).empty().append("Failed fetching suggestions..")
                    })
                };
                i.autocompleters.notifications.getEl(o).empty().append(r("<span>Fetchting autocompletions &nbsp;</span>")).append(r(n.svg.getElement(e("../imgs.js").loader)).addClass("notificationLoader"));
                d()
            };
            i.exports = {
                fetchFromLov: s,
                preprocessResourceTokenForCompletion: o,
                postprocessResourceTokenForCompletion: t
            }
        }, {"../imgs.js": 28, "./utils.js": 25, jquery: void 0, "yasgui-utils": 17}], 26: [function (e, i) {
            "use strict";
            var r = function () {
                try {
                    return e("jquery")
            ...
            i.exports = function (e) {
                return {
                    isValidCompletionPosition: function () {
                        ...
                        if ("ws" != i.type) {
                            i = e.getCompleteToken(i);
                            if (i && 0 == i.string.indexOf("?"))return !0
                        }
                        return !1
                    }, get: function (i) {
                        if (0 == i.trim().length)return [];
                        var n = {};
                        r(e.getWrapperElement()).find(".cm-atom").each(function () {
                            var e = this.innerHTML;
                            if (0 == e.indexOf("?")) {
                                var o = r(this).next(), t = o.attr("class");
                                t && o.attr("class").indexOf("cm-atom") >= 0 && (e += o.text());
                        ...
                        o.sort();
                        return o
                    }, async: !1, bulk: !1, autoShow: !0
                }
            }
        }, {jquery: void 0}], 27: [function (e) {
            var i = function () {
                try {
                    return e("jquery")
                } catch (i) {
            ...
            r.defaults = i.extend(!0, {}, r.defaults, {
                mode: "sparql11",
                ...
                lineWrapping: !0,
                backdrop: !1,
                foldGutter: {rangeFinder: r.fold.brace},
                gutters: ["gutterErrorBar", "CodeMirror-linenumbers", "CodeMirror-foldgutter"],
                matchBrackets: !0,
                fixedGutter: !0,
                syntaxErrorCheck: !0,
                extraKeys: {
                    "Ctrl-Space": r.autoComplete,
                    "Cmd-Space": r.autoComplete,
                    "Ctrl-D": r.deleteLine,
                    "Ctrl-K": r.deleteLine,
                    "Cmd-D": r.deleteLine,
                    "Cmd-K": r.deleteLine,
                    "Ctrl-/": r.commentLines,
                    "Cmd-/": r.commentLines,
                    "Ctrl-Alt-Down": r.copyLineDown,
                    "Ctrl-Alt-Up": r.copyLineUp,
                    "Cmd-Alt-Down": r.copyLineDown,
                    "Cmd-Alt-Up": r.copyLineUp,
                    "Shift-Ctrl-F": r.doAutoFormat,
                    "Shift-Cmd-F": r.doAutoFormat,
                    "Ctrl-]": r.indentMore,
                    "Cmd-]": r.indentMore,
                    "Ctrl-[": r.indentLess,
                    "Cmd-[": r.indentLess,
                    "Ctrl-S": r.storeQuery,
                    "Cmd-S": r.storeQuery,
                    "Ctrl-Enter": r.executeQuery,
                    "Cmd-Enter": r.executeQuery,
                    F11: function (e) {
                        e.setOption("fullScreen", !e.getOption("fullScreen"))
                    },
                    Esc: function (e) {
                        e.getOption("fullScreen") && e.setOption("fullScreen", !1)
                    }
                },
                cursorHeight: .9,
                createShareLink: r.createShareLink,
                consumeShareLink: r.consumeShareLink,
                persistent: function (e) {
                    return "yasqe_" + i(e.getWrapperElement()).closest("[id]").attr("id") + "_queryVal"
                },
                sparql: {
                    showQueryButton: !1,
                    ...
                    args: [],
                    headers: {},
                    callbacks: {beforeSend: null, complete: null, error: null, success: null},
                    handlers: {}
                }
            })
        }, {"./main.js": 29, jquery: void 0}], 28: [function (e, i) {
            "use strict";
            i.exports = {
            ...
            }(), o = e("./utils.js"), t = e("yasgui-utils"), s = e("./imgs.js");
            e("../lib/deparam.js");
            e("codemirror/addon/fold/foldcode.js");
            e("codemirror/addon/fold/foldgutter.js");
            e("codemirror/addon/fold/xml-fold.js");
            e("codemirror/addon/fold/brace-fold.js");
            e("codemirror/addon/hint/show-hint.js");
            e("codemirror/addon/search/searchcursor.js");
            e("codemirror/addon/edit/matchbrackets.js");
            e("codemirror/addon/runmode/runmode.js");
            e("codemirror/addon/display/fullscreen.js");
            e("../lib/grammar/tokenizer.js");
            var a = i.exports = function (e, i) {
                var o = r("<div>", {"class": "yasqe"}).appendTo(r(e));
                i = p(i);
                var t = l(n(o[0], i));
                c(t);
                return t
            }, p = function (e) {
                var i = r.extend(!0, {}, a.defaults, e);
                return i
            }, l = function (i) {
                i.autocompleters = e("./autocompleters/autocompleterBase.js")(a, i);
                i.options.autocompleters && i.options.autocompleters.forEach(function (e) {
                    a.Autocompleters[e] && i.autocompleters.init(e, a.Autocompleters[e])
                });
                i.getCompleteToken = function (r, n) {
                    return e("./tokenUtils.js").getCompleteToken(i, r, n)
                };
                i.getPreviousNonWsToken = function (r, n) {
                    return e("./tokenUtils.js").getPreviousNonWsToken(i, r, n)
                };
                i.getNextNonWsToken = function (r, n) {
                    return e("./tokenUtils.js").getNextNonWsToken(i, r, n)
                };
                var n = null, o = null;
                i.setBackdrop = function (e) {
                    if (i.options.backdrop || 0 === i.options.backdrop || "0" === i.options.backdrop) {
                        if (null === o) {
                            o = +i.options.backdrop;
                            1 === o && (o = 400)
                        }
                        n || (n = r("<div>", {"class": "backdrop"}).click(function () {
                            r(this).hide()
                        }).insertAfter(r(i.getWrapperElement())));
                        e ? n.show(o) : n.hide(o)
                    }
                };
                i.query = function (e) {
                ...
                i.getUrlArguments = function (e) {
                    return a.getUrlArguments(i, e)
                };
                i.getPrefixesFromQuery = function () {
                    return e("./prefixUtils.js").getPrefixesFromQuery(i)
                };
                i.addPrefixes = function (r) {
                    return e("./prefixUtils.js").addPrefixes(i, r)
                };
                i.removePrefixes = function (r) {
                    return e("./prefixUtils.js").removePrefixes(i, r)
                };
                i.getValueWithoutComments = function () {
                    var e = "";
                    a.runMode(i.getValue(), "sparql11", function (i, r) {
                        "comment" != r && (e += i)
                    });
                    return e
                };
                ...
                i.getQueryMode = function () {
                    var e = i.getQueryType();
                    return "INSERT" == e || "DELETE" == e || "LOAD" == e || "CLEAR" == e || "CREATE" == e || "DROP" == e || "COPY" == e || "MOVE" == e || "ADD" == e ? "update" : "query"
                };
                i.setCheckSyntaxErrors = function (e) {
                    i.options.syntaxErrorCheck = e;
                    N(i)
                };
                i.enableCompleter = function (e) {
                    E(i.options, e);
                    a.Autocompleters[e] && i.autocompleters.init(e, a.Autocompleters[e])
                };
                i.disableCompleter = function (e) {
                    u(i.options, e)
                };
                return i
            }, E = function (e, i) {
                e.autocompleters || (e.autocompleters = []);
                e.autocompleters.push(i)
            }, u = function (e, i) {
                if ("object" == typeof e.autocompleters) {
                    var n = r.inArray(i, e.autocompleters);
                    if (n >= 0) {
                        e.autocompleters.splice(n, 1);
                        u(e, i)
                    }
                }
            }, c = function (e) {
                var i = o.getPersistencyId(e, e.options.persistent);
                if (i) {
                ...
                e.on("change", function (e) {
                    N(e);
                    a.updateQueryButton(e);
                    a.positionButtons(e)
                });
                e.on("changes", function () {
                    N(e);
                    a.updateQueryButton(e);
                    a.positionButtons(e)
                });
                ...
                N(e);
                a.positionButtons(e);
                if (e.options.consumeShareLink) {
                    var s = r.deparam(window.location.search.substring(1));
                    e.options.consumeShareLink(e, s)
                }
            }, d = function (e) {
                e.cursor = r(".CodeMirror-cursor");
                e.buttons && e.buttons.is(":visible") && e.cursor.length > 0 && (o.elementsOverlap(e.cursor, e.buttons) ? e.buttons.find("svg").attr("opacity", "0.2") : e.buttons.find("svg").attr("opacity", "1.0"))
            }, N = function (i, n) {
                i.queryValid = !0;
                i.clearGutter("gutterErrorBar");
                for (var o = null, a = 0; a < i.lineCount(); ++a) {
                    var p = !1;
                    i.prevQueryValid || (p = !0);
                    var l = i.getTokenAt({line: a, ch: i.getLine(a).length}, p), o = l.state;
                    i.queryType = o.queryType;
                    if (0 == o.OK) {
                        if (!i.options.syntaxErrorCheck) {
                            r(i.getWrapperElement).find(".sp-error").css("color", "black");
                            return
                        }
                        var E = t.svg.getElement(s.warning);
                        o.possibleCurrent && o.possibleCurrent.length > 0 && e("./tooltip")(i, E, function () {
                            var e = [];
                            o.possibleCurrent.forEach(function (i) {
                                e.push("<strong style='text-decoration:underline'>" + r("<div/>").text(i).html() + "</strong>")
                            });
                            return "This line is invalid. Expected: " + e.join(", ")
                        });
                        E.style.marginTop = "2px";
                        E.style.marginLeft = "2px";
                        E.className = "parseErrorIcon";
                        i.setGutterMarker(a, "gutterErrorBar", E);
                        i.queryValid = !1;
                        break
                    }
                }
                i.prevQueryValid = i.queryValid;
                if (n && null != o && void 0 != o.stack) {
                    var u = o.stack, c = o.stack.length;
                    c > 1 ? i.queryValid = !1 : 1 == c && "solutionModifier" != u[0] && "?limitOffsetClauses" != u[0] && "?offsetClause" != u[0] && (i.queryValid = !1)
                }
            };
            r.extend(a, n);
            a.Autocompleters = {};
            a.registerAutocompleter = function (e, i) {
                a.Autocompleters[e] = i;
                E(a.defaults, e)
            };
            a.autoComplete = function (e) {
                e.autocompleters.autoComplete(!1)
            };
            a.registerAutocompleter("prefixes", e("./autocompleters/prefixes.js"));
            a.registerAutocompleter("properties", e("./autocompleters/properties.js"));
            a.registerAutocompleter("classes", e("./autocompleters/classes.js"));
            a.registerAutocompleter("variables", e("./autocompleters/variables.js"));
            a.positionButtons = function (e) {
                var i = r(e.getWrapperElement()).find(".CodeMirror-vscrollbar"), n = 0;
                i.is(":visible") && (n = i.outerWidth());
                e.buttons.is(":visible") && e.buttons.css("right", n + 6)
            };
            a.createShareLink = function (e) {
                var i = r.deparam(window.location.search.substring(1));
                i.query = e.getValue();
                return i
            };
            a.consumeShareLink = function (e, i) {
                i.query && e.setValue(i.query)
            };
            a.drawButtons = function (e) {
                e.buttons = r("<div class='yasqe_buttons'></div>").appendTo(r(e.getWrapperElement()));
                if (e.options.createShareLink) {
                    var i = r(t.svg.getElement(s.share));
                    i.click(function (n) {
                        n.stopPropagation();
                        var o = r("<div class='yasqe_sharePopup'></div>").appendTo(e.buttons);
                        r("html").click(function () {
                            o && o.remove()
                        });
                        o.click(function (e) {
                            e.stopPropagation()
                        });
                        var t = r("<textarea></textarea>").val(location.protocol + "//" + location.host + location.pathname + "?" + r.param(e.options.createShareLink(e)));
                        t.focus(function () {
                            var e = r(this);
                            e.select();
                            e.mouseup(function () {
                        ...
                        o.empty().append(t);
                        var s = i.position();
                        o.css("top", s.top + i.outerHeight() + "px").css("left", s.left + i.outerWidth() - o.outerWidth() + "px")
                    }).addClass("yasqe_share").attr("title", "Share your query").appendTo(e.buttons)
                }
                var n = r("<div>", {"class": "fullscreenToggleBtns"}).append(r(t.svg.getElement(s.fullscreen)).addClass("yasqe_fullscreenBtn").attr("title", "Set editor full screen").click(function () {
                    e.setOption("fullScreen", !0)
                })).append(r(t.svg.getElement(s.smallscreen)).addClass("yasqe_smallscreenBtn").attr("title", "Set editor to normale size").click(function () {
                    e.setOption("fullScreen", !1)
                }));
                e.buttons.append(n);
                if (e.options.sparql.showQueryButton) {
                    r("<div>", {"class": "yasqe_queryButton"}).click(function () {
                        if (r(this).hasClass("query_busy")) {
                            e.xhr && e.xhr.abort();
                            a.updateQueryButton(e)
                        } else e.query()
                    }).appendTo(e.buttons);
            ...
            var I = {busy: "loader", valid: "query", error: "queryInvalid"};
            a.updateQueryButton = function (e, i) {
                var n = r(e.getWrapperElement()).find(".yasqe_queryButton");
                if (0 != n.length) {
                    if (!i) {
                        i = "valid";
                        e.queryValid === !1 && (i = "error")
                    }
                    if (i != e.queryStatus && ("busy" == i || "valid" == i || "error" == i)) {
                        n.empty().removeClass(function (e, i) {
                            return i.split(" ").filter(function (e) {
                                return 0 == e.indexOf("query_")
                            }).join(" ")
                        }).addClass("query_" + i);
                        t.svg.draw(n, s[I[i]]);
                        e.queryStatus = i
            ...
            a.fromTextArea = function (e, i) {
                i = p(i);
                var o = (r("<div>", {"class": "yasqe"}).insertBefore(r(e)).append(r(e)), l(n.fromTextArea(e, i)));
                c(o);
                return o
            };
            a.storeQuery = function (e) {
                var i = o.getPersistencyId(e, e.options.persistent);
                i && t.storage.set(i, e.getValue(), "month")
            };
            a.commentLines = function (e) {
                for (var i = e.getCursor(!0).line, r = e.getCursor(!1).line, n = Math.min(i, r), o = Math.max(i, r), t = !0, s = n; o >= s; s++) {
                    var a = e.getLine(s);
                    if (0 == a.length || "#" != a.substring(0, 1)) {
                        t = !1;
                        break
                    }
                }
                for (var s = n; o >= s; s++)t ? e.replaceRange("", {line: s, ch: 0}, {
                    line: s,
                    ch: 1
                }) : e.replaceRange("#", {line: s, ch: 0})
            };
            a.copyLineUp = function (e) {
                var i = e.getCursor(), r = e.lineCount();
                e.replaceRange("\n", {line: r - 1, ch: e.getLine(r - 1).length});
                for (var n = r; n > i.line; n--) {
                    var o = e.getLine(n - 1);
                    e.replaceRange(o, {line: n, ch: 0}, {line: n, ch: e.getLine(n).length})
                }
            };
            a.copyLineDown = function (e) {
                a.copyLineUp(e);
                var i = e.getCursor();
                i.line++;
                e.setCursor(i)
            };
            a.doAutoFormat = function (e) {
                if (e.somethingSelected()) {
                    var i = {line: e.getCursor(!1).line, ch: e.getSelection().length};
                    x(e, e.getCursor(!0), i)
                } else {
                    var r = e.lineCount(), n = e.getTextArea().value.length;
                    x(e, {line: 0, ch: 0}, {line: r, ch: n})
                }
            };
            var x = function (e, i, r) {
                var n = e.indexFromPos(i), o = e.indexFromPos(r), t = m(e.getValue(), n, o);
                e.operation(function () {
                    e.replaceRange(t, i, r);
                    for (var o = e.posFromIndex(n).line, s = e.posFromIndex(n + t.length).line, a = o; s >= a; a++)e.indentLine(a, "smart")
                })
            }, m = function (e, i, o) {
                e = e.substring(i, o);
                var t = [["keyword", "ws", "prefixed", "ws", "uri"], ["keyword", "ws", "uri"]], s = ["{", ".", ";"], a = ["}"], p = function (e) {
                    for (var i = 0; i < t.length; i++)if (u.valueOf().toString() == t[i].valueOf().toString())return 1;
                    for (var i = 0; i < s.length; i++)if (e == s[i])return 1;
                    for (var i = 0; i < a.length; i++)if ("" != r.trim(E) && e == a[i])return -1;
                    return 0
                }, l = "", E = "", u = [];
                n.runMode(e, "sparql11", function (e, i) {
                    u.push(i);
                    var r = p(e, i);
                    if (0 != r) {
                        if (1 == r) {
                    ...
                    1 == u.length && "sp-ws" == u[0] && (u = [])
                });
                return r.trim(l.replace(/\n\s*\n/g, "\n"))
            };
            e("./sparql.js"), e("./defaults.js");
            a.version = {
                CodeMirror: n.version,
                YASQE: e("../package.json").version,
                jquery: r.fn.jquery,
                "yasgui-utils": t.version
            }
        }, {
            "../lib/deparam.js": 2,
            "../lib/grammar/tokenizer.js": 4,
            "../package.json": 20,
            "./autocompleters/autocompleterBase.js": 21,
            "./autocompleters/classes.js": 22,
            "./autocompleters/prefixes.js": 23,
            "./autocompleters/properties.js": 24,
            "./autocompleters/variables.js": 26,
            "./defaults.js": 27,
            "./imgs.js": 28,
            "./prefixUtils.js": 30,
            "./sparql.js": 31,
            ...
            "./utils.js": 34,
            codemirror: void 0,
            "codemirror/addon/display/fullscreen.js": 6,
            "codemirror/addon/edit/matchbrackets.js": 7,
            "codemirror/addon/fold/brace-fold.js": 8,
            "codemirror/addon/fold/foldcode.js": 9,
            "codemirror/addon/fold/foldgutter.js": 10,
            "codemirror/addon/fold/xml-fold.js": 11,
            "codemirror/addon/hint/show-hint.js": 12,
            "codemirror/addon/runmode/runmode.js": 13,
            "codemirror/addon/search/searchcursor.js": 14,
            jquery: void 0,
            "yasgui-utils": 17
        }], 30: [function (e, i) {
            "use strict";
            var r = function (e, i) {
                var r = e.getPrefixesFromQuery();
                if ("string" == typeof i)n(e, i); else for (var o in i)o in r || n(e, o + ": <" + i[o] + ">")
            }, n = function (e, i) {
                for (var r = null, n = 0, o = e.lineCount(), t = 0; o > t; t++) {
                    var a = e.getNextNonWsToken(t);
                    if (null != a && ("PREFIX" == a.string || "BASE" == a.string)) {
                        r = a;
                        n = t
                    }
                }
                ...
                for (var n in i)e.setValue(e.getValue().replace(new RegExp("PREFIX\\s*" + n + ":\\s*" + r("<" + i[n] + ">") + "\\s*", "ig"), ""))
            }, t = function (e) {
                for (var i = {}, r = !0, n = function (o, s) {
                    if (r) {
                        s || (s = 1);
                        var a = e.getNextNonWsToken(t, s);
                        if (a) {
                            -1 == a.state.possibleCurrent.indexOf("PREFIX") && -1 == a.state.possibleNext.indexOf("PREFIX") && (r = !1);
                            if ("PREFIX" == a.string.toUpperCase()) {
                                var p = e.getNextNonWsToken(t, a.end + 1);
                                if (p) {
                                    var l = e.getNextNonWsToken(t, p.end + 1);
                                    if (l) {
                                        var E = l.string;
                                        0 == E.indexOf("<") && (E = E.substring(1));
                                        ">" == E.slice(-1) && (E = E.substring(0, E.length - 1));
                                        i[p.string.slice(0, -1)] = E;
                                        n(o, l.end + 1)
                                    } else n(o, p.end + 1)
                                } else n(o, a.end + 1)
                            } else n(o, a.end + 1)
                ...
                }, o = e.lineCount(), t = 0; o > t && r; t++)n(t);
                return i
            }, s = function (e, i, r) {
                void 0 == r && (r = 1);
                var n = e.getTokenAt({line: i, ch: r});
                return null == n || void 0 == n || "ws" != n.type ? "" : n.string + s(e, i, n.end + 1)
            };
            i.exports = {addPrefixes: r, getPrefixesFromQuery: t, removePrefixes: o}
        }, {}], 31: [function (e) {
            "use strict";
            var i = function () {
                try {
            ...
            r.executeQuery = function (e, o) {
                var t = "function" == typeof o ? o : null, s = "object" == typeof o ? o : {};
                e.options.sparql && (s = i.extend({}, e.options.sparql, s));
                s.handlers && i.extend(!0, s.callbacks, s.handlers);
                if (s.endpoint && 0 != s.endpoint.length) {
                    var a = {
                        url: "function" == typeof s.endpoint ? s.endpoint(e) : s.endpoint,
                        type: "function" == typeof s.requestMethod ? s.requestMethod(e) : s.requestMethod,
                        headers: {Accept: n(e, s)}
                    }, p = !1;
                    if (s.callbacks)for (var l in s.callbacks)if (s.callbacks[l]) {
                        p = !0;
                        a[l] = s.callbacks[l]
                    }
                    a.data = e.getUrlArguments(s);
                    if (p || t) {
                        t && (a.complete = t);
                        s.headers && !i.isEmptyObject(s.headers) && i.extend(a.headers, s.headers);
                        r.updateQueryButton(e, "busy");
                        e.setBackdrop(!0);
                        var E = function () {
                            r.updateQueryButton(e);
                            e.setBackdrop(!1)
                        };
                        a.complete = a.complete ? [E, a.complete] : E;
                        e.xhr = i.ajax(a)
                    }
                }
            };
            r.getUrlArguments = function (e, r) {
                var n = e.getQueryMode(), o = [{name: e.getQueryMode(), value: e.getValue()}];
                if (r.namedGraphs && r.namedGraphs.length > 0)for (var t = "query" == n ? "named-graph-uri" : "using-named-graph-uri ", s = 0; s < r.namedGraphs.length; s++)o.push({
                    name: t,
                    value: r.namedGraphs[s]
                });
                if (r.defaultGraphs && r.defaultGraphs.length > 0)for (var t = "query" == n ? "default-graph-uri" : "using-graph-uri ", s = 0; s < r.defaultGraphs.length; s++)o.push({
                    name: t,
                    value: r.defaultGraphs[s]
                });
                r.args && r.args.length > 0 && i.merge(o, r.args);
                return o
            };
            var n = function (e, i) {
                var r = null;
                if (!i.acceptHeader || i.acceptHeaderGraph || i.acceptHeaderSelect || i.acceptHeaderUpdate)if ("update" == e.getQueryMode())r = "function" == typeof i.acceptHeader ? i.acceptHeaderUpdate(e) : i.acceptHeaderUpdate; else {
                    var n = e.getQueryType();
                    r = "DESCRIBE" == n || "CONSTRUCT" == n ? "function" == typeof i.acceptHeaderGraph ? i.acceptHeaderGraph(e) : i.acceptHeaderGraph : "function" == typeof i.acceptHeaderSelect ? i.acceptHeaderSelect(e) : i.acceptHeaderSelect
                } else r = "function" == typeof i.acceptHeader ? i.acceptHeader(e) : i.acceptHeader;
                return r
            }
        }, {"./main.js": 29, jquery: void 0}], 32: [function (e, i) {
            "use strict";
            var r = function (e, i, n) {
                n || (n = e.getCursor());
                i || (i = e.getTokenAt(n));
                var o = e.getTokenAt({line: n.line, ch: i.start});
                if (null != o.type && "ws" != o.type && null != i.type && "ws" != i.type) {
                    i.start = o.start;
                    i.string = o.string + i.string;
                    return r(e, i, {line: n.line, ch: o.start})
                }
                if (null != i.type && "ws" == i.type) {
                    i.start = i.start + 1;
                    i.string = i.string.substring(1);
                    return i
                }
                return i
            }, n = function (e, i, r) {
                var o = e.getTokenAt({line: i, ch: r.start});
                null != o && "ws" == o.type && (o = n(e, i, o));
                return o
            }, o = function (e, i, r) {
                void 0 == r && (r = 1);
                var n = e.getTokenAt({line: i, ch: r});
                return null == n || void 0 == n || n.end < r ? null : "ws" == n.type ? o(e, i, n.end + 1) : n
            };
            i.exports = {getPreviousNonWsToken: n, getCompleteToken: r, getNextNonWsToken: o}
        }, {}], 33: [function (e, i) {
            "use strict";
            {
                var r = function () {
            ...
            i.exports = function (e, i, n) {
                var o, i = r(i);
                i.hover(function () {
                    "function" == typeof n && (n = n());
                    o = r("<div>").addClass("yasqe_tooltip").html(n).appendTo(i);
                    t()
                }, function () {
                    r(".yasqe_tooltip").remove()
                });
                var t = function () {
                    if (r(e.getWrapperElement()).offset().top >= o.offset().top) {
                        o.css("bottom", "auto");
                        o.css("top", "26px")
                    }
                }
            }
        }, {"./utils.js": 34, jquery: void 0}], 34: [function (e, i) {
            "use strict";
            var r = function () {
                try {
                    return e("jquery")
                ...
                function e(e) {
                    ...
                    n = r(e).width();
                    o = r(e).height();
                    return [[i.left, i.left + n], [i.top, i.top + o]]
                }
                ...
                function i(e, i) {
                    ...
                    r = e[0] < i[0] ? e : i;
                    n = e[0] < i[0] ? i : e;
                    return r[1] > n[0] || r[0] === n[0]
                }

                return function (r, n) {
                    var o = e(r), t = e(n);
                    return i(o[0], t[0]) && i(o[1], t[1])
                }
            }();
            i.exports = {keyExists: n, getPersistencyId: o, elementsOverlap: t}
        }, {jquery: void 0}]
    }, {}, [1])(1)
});
